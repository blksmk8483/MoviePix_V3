    ...
    (n = function () {
      ...
      function v(e, t) {
        ...
        if (
          ...
          for (n = 0; n < a; n++) s((i = t[(r = _[n])])) || (e[r] = i);
        return e;
      }
      function w(e) {
        v(this, e),
      ...
      function eb(e, t) {
        ...
        var n = ((t % 12) + 12) % 12;
        return (
          (e += (t - n) / 12), 1 === n ? (ep(e) ? 29 : 28) : 31 - ((n % 7) % 2)
        );
      }
      ...
      var eS = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),
        eM = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/;
      function eD(e, t, n) {
        var r,
          i,
      ...
      function eY(e, t) {
        ...
        var n = t,
          r = e.date();
        return (
          (r = r < 29 ? r : Math.min(r, eb(e.year(), n))),
      ...
      R("H", ["HH", 2], 0, "hour"),
        ...
        R("hmmss", 0, 0, function () {
          return (
            "" + eF.apply(this) + T(this.minutes(), 2) + T(this.seconds(), 2)
          );
        }),
        R("Hmm", 0, 0, function () {
      ...
      function e8(e) {
        ...
        if (c) {
          if (
            ...
            (l = c[1]) &&
              eW.indexOf(l) !== new Date(u[0], u[1], u[2]).getDay() &&
        ...
        if (!e._d) {
          for (
            h = new Date(t.now()),
              ...
              null != e._dayOfYear &&
                ((_ = te(e._a[0], y[0])),
                (e._dayOfYear > e_(_) || 0 === e._dayOfYear) &&
                  (d(e)._overflowDayOfYear = !0),
                (m = eN(_, 0, e._dayOfYear)),
      ...
      function tn(e) {
        ...
        var n,
          ...
          _ = 0;
        for (
          o = 0, m = (l = W(e._f, e._locale).match(N) || []).length;
          o < m;
          o++
        )
          ((c = l[o]),
              ...
              (l =
                n.isValid() && r.isValid()
                  ? ((r = tp(r, n)),
                    n.isBefore(r)
                      ? (a = tS(n, r))
                      : (((a = tS(r, n)).milliseconds = -a.milliseconds),
                        (a.months = -a.months)),
                    a)
      ...
      function tH(e, t, n, r, i) {
        ...
        return null == e
          ? eL(this, r, i).year
          : (t > (a = eR(e, r, i)) && (t = a), tF.call(this, e, t, n, r, i));
      }
      ...
      (tV.add = tY),
        ...
        (tV.diff = function (e, t, n) {
          ...
          switch (
            ((i = (r.utcOffset() - this.utcOffset()) * 6e4), (t = H(t)))
          ) {
            case "year":
              a = tT(this, r) / 12;
              break;
        ...
        (tV.get = function (e) {
          return Y(this[(e = H(e))]) ? this[e]() : this;
        }),
        ...
        (tV.set = function (e, t) {
          ...
          } else if (Y(this[(e = H(e))])) return this[e](t);
          return this;
        }),
        ...
        (tV.millisecond = tV.milliseconds = p),
        (tV.utcOffset = function (e, n, r) {
          var i,
            a = this._offset || 0;
          if (!this.isValid()) return null != e ? this : NaN;
          if (null == e) return this._isUTC ? a : t_(this);
          if ("string" == typeof e) {
            if (null === (e = ty(ea, e))) return this;
          } else 16 > Math.abs(e) && !r && (e *= 60);
          return (
            !this._isUTC && n && (i = t_(this)),
            (this._offset = e),
            (this._isUTC = !0),
            null != i && this.add(i, "m"),
            a === e ||
        ...
        (tV.dates = S("dates accessor is deprecated. Use date instead.", tU)),
        (tV.months = S("months accessor is deprecated. Use month instead", eO)),
        (tV.years = S("years accessor is deprecated. Use year instead", eg)),
        (tV.zone = S(
      ...
      (tz.calendar = function (e, t, n) {
        ...
        (tz.erasAbbrRegex = function (e) {
          return (
            i(this, "_erasAbbrRegex") || tW.call(this),
            e ? this._erasAbbrRegex : this._erasRegex
          );
        }),
        (tz.erasNameRegex = function (e) {
          return (
            i(this, "_erasNameRegex") || tW.call(this),
            e ? this._erasNameRegex : this._erasRegex
          );
        }),
        (tz.erasNarrowRegex = function (e) {
          return (
            i(this, "_erasNarrowRegex") || tW.call(this),
        ...
        (tz.weekdays = function (e, t) {
          ...
          return !0 === e ? eC(r, this._week.dow) : e ? r[e.day()] : r;
        }),
        (tz.weekdaysMin = function (e) {
          return !0 === e
            ? eC(this._weekdaysMin, this._week.dow)
            : e
        ...
        (tz.weekdaysShort = function (e) {
          return !0 === e
            ? eC(this._weekdaysShort, this._week.dow)
            : e
        ...
        (tz.weekdaysRegex = function (e) {
          return this._weekdaysParseExact
            ? (i(this, "_weekdaysRegex") || eH.call(this), e)
      ...
      return (
        ...
        (ny.humanize = function (e, t) {
          ...
          return (
            ...
            "object" == typeof t &&
              ((p = Object.assign({}, nc, t)),
              null != t.s && null == t.ss && (p.ss = t.s - 1)),
            (f = this.localeData()),
            (n = !y),
            (r = p),
            (i = tk(this).abs()),
...
ew = function (e, t) {
  try {
    ek(b, e, { value: t, configurable: !0, writable: !0 });
  } catch (n) {
    b[e] = t;
  }
  return t;
};
var eb = "__core-js_shared__",
  eS = (eg = b[eb] || ew(eb, {}));
(eS.versions || (eS.versions = [])).push({
  version: "3.37.1",
  mode: ev ? "pure" : "global",
...
var ej = {},
  eH = {},
  eF = b.document,
  eU = Z(eF) && Z(eF.createElement);
(eH = function (e) {
  return eU ? eF.createElement(e) : {};
}),
  (ej =
    !M &&
    !D(function () {
      return (
        7 !==
        Object.defineProperty(eH("div"), "a", {
          get: function () {
            return 7;
          },
        }).a
...
(Function.prototype.toString = tp(function () {
...
(tC = tj),
  (k = function (e, t) {
    var r,
      ...
      l = e.global,
      c = e.stat;
    if ((r = l ? b : c ? b[u] || ew(u, {}) : b[u] && b[u].prototype))
      for (i in t) {
        if (
          ((s = t[i]),
          (a = e.dontCallGetSet ? (o = n(r, i)) && o.value : r[i]),
          !tC(l ? i : u + (c ? "." : "#") + i, e.forced) && void 0 !== a)
        ) {
...
var t1 = {};
t1 = "process" === H(b.process);
var t2 = b.setImmediate,
  t4 = b.clearImmediate,
  t3 = b.process,
  t6 = b.Dispatch,
  t5 = b.Function,
...
var nn = function (e) {
  ...
  na = function (e) {
    b.postMessage(t9(e), d.protocol + "//" + d.host);
  };
(t2 && t4) ||
  ((t2 = function (e) {
  ...
  t1
    ...
    : b.addEventListener &&
      ...
      "file:" !== d.protocol &&
      !D(na)
    ? ((f = na), b.addEventListener("message", ni, !1))
    : (f =
        nt in eH("script")
          ? function (e) {
              tJ.appendChild(eH("script"))[nt] = function () {
...
k(
  { global: !0, bind: !0, enumerable: !0, forced: b.clearImmediate !== ns },
  { clearImmediate: ns }
);
var no = tG.set,
  nu = {},
...
var nc = b.Function,
  nh =
    /MSIE .\./.test(er) ||
    (nl &&
      ((t = b.Bun.version.split(".")).length < 3 ||
...
var nd = b.setImmediate ? nu(no, !1) : no;
k(
  { global: !0, bind: !0, enumerable: !0, forced: b.setImmediate !== nd },
  { setImmediate: nd }
);
...
const nw = {
  ...
  nk = async function (e) {
    try {
      ...
      let t = await ng(`${nf}${np}/${e}?language=${ny}`);
      console.log("LOAD MOVIE", t),
        (nw.movie = {
          ...
          image: t.poster_path,
          runtime: t.runtime,
          releaseDate: _(nv)(t.release_date).format("YYYY"),
          genres: t.genres,
          tagline: t.tagline,
          homepage: t.homepage,
        });
    ...
    try {
      ...
      nw.search.results.push(
        ...n.results.map((e) => ({
          ...
          genreID: e.genre_ids,
          releaseDate: _(nv)(e.release_date).format("YYYY"),
        }))
      ),
...
const nM = function (e = nw.search.page) {
  ...
  nD = async function () {
    try {
      let e = await ng(`
      ${nf}${np}/popular?language=en-US&page=1`);
...
var nY = {};
nY = new URL("popcornHoldTheButter.571d0373.webp", import.meta.url).toString();
var nO = {};
nO = new URL(
  "spilledPopcornHoldTheButter.135b79f6.webp",
  import.meta.url
).toString();
class nx {
  _data;
  ...
  renderError(e = this._errorMessage) {
    ...
    <div class="error mt-7 col-span-full">
         <img class="bg-center max-h-svh" src="${_(nO)}">
...
var nE = new nP(),
  nL = {};
nL = new URL("popcornHoldTheButter.571d0373.webp", import.meta.url).toString();
class nR extends nx {
     ...
     <li class="m-1.5 p-0 bg-slate-700">
      <a class="" href="#${e.id}">
        ...
        <section class="my-0 ml-1.5 content-center text-white text-base tracking-wide">
          <h4 class="pt-0.5">${e.title}</h4>
          <p class="pb-2">${e.releaseDate}</p>
        </section>
      </a>
    </li>
    `;
...
class nW extends nx {
  ...
  _generateMarkupOMG(e) {
    ...
    <li class="m-1.5 p-0 bg-slate-800 text-white">
      <a href="#${e.id}">
        <img class="m-0 bg-cover" src="${nm}${e.image}" alt="${e.title}" />https://file+.vscode-resource.vscode-cdn.net/Users/brandonknight/Desktop/API%20PROJECTS/MoviePix_V3/src/img/spilledPopcornHoldTheButter.webp?version%3D1721093313359
        <h2 class="my-0 ml-1 pt-1 text-lg content-center font-medium tracking-wide">${e.title}</h2>
      </a>
    </li>
    `;
  }
...
var nj = new nW(),
  nH = (function (e) {
    ...
    function c(e, n, r, a) {
      var s,
        o,
        u = Object.create((n && n.prototype instanceof p ? n : p).prototype);
      return (
        i(u, "_invoke", {
          value:
            ((s = new O(a || [])),
...
try {
  regeneratorRuntime = nH;
} catch (e) {
  "object" == typeof globalThis
    ? (globalThis.regeneratorRuntime = nH)
    : Function("r", "regeneratorRuntime = r")(nH);
}
const nF = async function () {
    try {
      (nw.view = "initial"),
        nj.renderSpinner(),
        await nD(),
  ...
  nG = async function () {
    try {
      ...
      nN._clear(), nC.renderError();
    }
  },
  nA = async function () {
    try {
      await nS(nw.search.query, nw.search.nextPage),
        nC.render(nw.search.results);
    } catch (e) {
      console.log(e), nN._clear(), nC.renderError();
    }
  };
nj.addHandlerInit(nF),
  nN.addHandlerRender(nU),
  nN.addHandlerBack(nI),
  nE.addHandlerSearch(nG),
  nC.addScrollHandler(nA),
  window.addEventListener("hashchange", function () {
    window.location.hash ? nU() : nI();
  });
//# sourceMappingURL=index.6a768f68.js.map
