...
${frame.code}`;
    ...
    aenu9: [
      function (require, module, exports) {
        ...
        var _initialViewJsDefault =
          parcelHelpers.interopDefault(_initialViewJs);
        ...
        const controlStartingPage = async function () {
          try {
            ...
            (0, _initialViewJsDefault.default).render(
              _modelJs.state.popularMovie
            );
          } catch (err) {
            console.log(err);
          }
        ...
        const controlMovie = async function () {
          try {
            ...
            document
              .querySelector(".top-rated-container")
              .classList.add("hidden");
            document
              .querySelector(".now-playing-container")
              .classList.add("hidden");
            document
              .querySelector(".upcoming-container")
              .classList.add("hidden");
        ...
        const controlBackToInitial = function () {
          if (_modelJs.state.view === "movie") {
            ...
            _modelJs.state.view = _modelJs.state.search.query
              ? "search"
              : "initial";
        ...
        const controlLoadMoreResults = async function () {
          try {
            await _modelJs.fetchAllResults(
              _modelJs.state.search.query,
              _modelJs.state.search.nextPage
            );
            (0, _resultsViewJsDefault.default).render(
              _modelJs.state.search.results
            );
        ...
        const init = function () {
          (0, _initialViewJsDefault.default).addHandlerInit(
            controlStartingPage
          );
          ...
          (0, _resultsViewJsDefault.default).addScrollHandler(
            controlLoadMoreResults
          );
...
*/ module.exports = function (options, source) {
    ...
    l4ncH: [
      ...
      {
        "7b43004672b1879f": "5ZsyC",
        "8756de416b94afec": "i8HOC",
        dfb72a1d809f7b02: "ggjnO",
      },
    ],
    "5ZsyC": [
      function (require, module, exports) {
        ...
        const loadMovie = async function (id) {
          try {
            ...
            const data = await (0, _helpersJs.getJSON)(
              `${(0, _configJs.API_URL)}${
                (0, _configJs.TV_OR_MOVIE)
              }/${id}?language=${(0, _configJs.USER_LANGUAGE)}`
            );
            ...
            state.movie = {
              ...
              releaseDate: (0, _momentDefault.default)(
                movie.release_date
              ).format("YYYY"),
              genres: movie.genres,
    ...
    e6B94: [
      function (require, module, exports) {
        ...
        class MovieView extends (0, _viewDefault.default) {
          ...
          _errorMessage =
            "Could not find that movie. <br> Please try another one.";
          _message = "";
    ...
    <section class="bg-slate-800 text-white">
      ...
      <img class="bg-center max-h-svh transition ease-in-out delay-500" src="${
        (0, _config.API_IMAGE)
      }${this._data.image}" alt="${this._data.title}" />
      <p class="mt-2.5 ml-4 mr-4 text-lg tracking-wide leading-relaxed text-balance">${
        this._data.overview
      }</p>
      <p class="ml-4 mt-4 text-lg tracking-wider">${this._data.releaseDate}</p>
      <p class="ml-4 pb-4 text-lg tracking-wider">${
        this._data.runtime
      } minutes</p>
    </section>
    `;
    ...
    "5cUXS": [
      function (require, module, exports) {
        ...
        var _popcornHoldTheButterWebpDefault = parcelHelpers.interopDefault(
          _popcornHoldTheButterWebp
        );
        var _spilledPopcornHoldTheButterWebp = require("url:../../img/spilledPopcornHoldTheButter.webp");
        var _spilledPopcornHoldTheButterWebpDefault =
          parcelHelpers.interopDefault(_spilledPopcornHoldTheButterWebp);
        class View {
          _data;
          render(data) {
    ...
    <div class = "spinner col-span-full">    
      <img class="bg-center" src="${
        (0, _popcornHoldTheButterWebpDefault.default)
    ...
    <div class="error mt-7 col-span-full">
         <img class="bg-center max-h-svh" src="${
           (0, _spilledPopcornHoldTheButterWebpDefault.default)
         }">
    ...
    `;
      ...
      {
        "url:../../img/popcornHoldTheButter.webp": "lNOMI",
        "url:../../img/spilledPopcornHoldTheButter.webp": "7D8xA",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    lNOMI: [
      function (require, module, exports) {
        module.exports =
          require("2565cc4d8420b816").getBundleURL("hWUTQ") +
          "popcornHoldTheButter.73b2eb3d.webp" +
          "?" +
          Date.now();
      },
      { "2565cc4d8420b816": "lgJ39" },
    ],
    lgJ39: [
      function (require, module, exports) {
        "use strict";
    ...
    "7D8xA": [
      function (require, module, exports) {
        module.exports =
          require("f5d79527d85a4b79").getBundleURL("hWUTQ") +
          "spilledPopcornHoldTheButter.bd11449b.webp" +
          "?" +
          Date.now();
      },
      { f5d79527d85a4b79: "lgJ39" },
    ],
    "9OQAM": [
      function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    ...
    cSbZE: [
      function (require, module, exports) {
        ...
        var _movieChairsHoldTheButterWebpDefault = parcelHelpers.interopDefault(
          _movieChairsHoldTheButterWebp
        );
        class ResultsView extends (0, _viewDefault.default) {
          ...
          _generateMarkupPreview(result) {
            const isImage = result.image
              ? `${(0, _config.API_IMAGE)}${result.image}`
              : (0, _movieChairsHoldTheButterWebpDefault.default);
            const releaseDate = isNaN(result.releaseDate)
              ? ""
              : result.releaseDate;
            return `
    ...
    `;
      ...
      },
      {
        "../config": "k5Hzs",
        "./View": "5cUXS",
        "../../img/movieChairs_HoldTheButter.webp": "81N47",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    "81N47": [
      function (require, module, exports) {
        module.exports =
          require("bfe064a6fee910d9").getBundleURL("hWUTQ") +
          "movieChairs_HoldTheButter.6331ab84.webp" +
          "?" +
          Date.now();
      },
      { bfe064a6fee910d9: "lgJ39" },
    ],
    cMmmU: [
      function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        ...
        class InitialView extends (0, _viewDefault.default) {
          ...
          _errorMessage =
            "Sorry, no popular movies are displaying at the moment.";
          ...
          _generateMarkupOMG(popularMovie) {
            const isImage = popularMovie.image
              ? `${(0, _config.API_IMAGE)}${popularMovie.image}`
              : (0, _movieChairsHoldTheButterWebpDefault.default);
            return `
    <li class="m-1.5 p-0 bg-slate-800 text-white snap-always snap-center">
      <a  href="#${popularMovie.id}">
        <img class="m-0 max-w-24 rounded-md" src="${
          (0, _config.API_IMAGE)
        }${isImage}" alt="${popularMovie.title}" />
        <h2 class="my-0 ml-1 pt-1 text-xs font-medium text-balance">${
          popularMovie.title
        }</h2>
      </a>
    </li>
