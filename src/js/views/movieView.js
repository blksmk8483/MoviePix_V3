  ...
  _generateMarkup() {
    return `
      ...
      <section class="bg-slate-800 text-white mx-1">
        <h2 class=" pt-2.5 text-3xl font-medium tracking-wide">${
          this._data.title
        }</h2>
        <p class=" mt-0.5  pb-1 text-base tracking-wider">${
          this._data.tagline
        }</p>
            ...
            .map((review, index) => {
              ...
              return `
                <section class="review ${
                  index > 0 ? "hidden" : ""
                } mb-4 p-1.5 text-lg tracking-wide leading-relaxed text-balance bg-slate-700 rounded">
