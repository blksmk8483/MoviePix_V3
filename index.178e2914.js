...
const nw = {
  ...
  nS = async function (e, t = 1) {
    try {
      ...
      console.log("LOAD SEARCH RESULTS", n),
...
const nM = function () {
    (nw.search.query = ""), (nw.search.results = []);
  },
  nD = function (e = nw.search.page) {
    nw.search.page = e;
...
var nO = {};
nO = new URL("popcorn.98f291c0.png", import.meta.url).toString();
var nx = {};
nx = new URL("spilled-popcorn.c0405803.png", import.meta.url).toString();
class nT {
  _data;
  render(e) {
  ...
  renderError(e = this._errorMessage) {
    ...
    <div class="error mt-7 col-span-full">
         <img class="bg-center max-h-svh" src="${p(nx)}">
...
var nL = new nE(),
  nR = {};
nR = new URL("popcorn.98f291c0.png", import.meta.url).toString();
class nC extends nT {
...
const nU = async function () {
    try {
      (nw.view = "initial"),
        nF.renderSpinner(),
        await nY(),
        nF.render(nw.popularMovie);
    } catch (e) {
      console.log(e);
    }
  },
  ...
  nA = async function () {
    try {
      ...
      console.log(e), nP._clear(), nW.renderError();
    }
  };
nF.addHandlerInit(nU),
  nP.addHandlerRender(nI),
  nP.addHandlerBack(function () {
    "movie" === nw.view &&
  ...
  nL.addHandlerSearch(nG),
  nW.addScrollHandler(nA);
//# sourceMappingURL=index.178e2914.js.map
