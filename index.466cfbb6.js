...
class nT extends nx {
  ...
  _generateMarkup() {
    ...
    <section class="bg-slate-800 text-white">
      ...
      <img class="bg-center max-h-svh transition ease-in-out delay-500" src="${nm}${this._data.image}" alt="${this._data.title}" />
...
var nE = new nP(),
  nL = {};
nL = new URL(
  "movieChairs_HoldTheButter.47bddc26.webp",
  import.meta.url
).toString();
class nR extends nx {
  ...
  _generateMarkupPreview(e) {
    let t = e.image ? `${nm}${e.image}` : p(nL),
      n = isNaN(e.releaseDate) ? "" : e.releaseDate;
    return `
...
class nW extends nx {
  ...
  _generateMarkupOMG(e) {
    ...
    <li class="m-1.5 p-0 bg-slate-800 text-white snap-always snap-center">
      <a  href="#${e.id}">
        <img class="m-0 max-w-24 rounded-md" src="${nm}${t}" alt="${e.title}" />
        <h2 class="my-0 ml-1 pt-1 text-xs font-medium text-balance">${e.title}</h2>
      </a>
    </li>
    `;
  }
...
//# sourceMappingURL=index.466cfbb6.js.map
