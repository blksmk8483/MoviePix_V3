...
const getAPIcall = async ()=>{
    try {
        ...
        const res = await fetch(`${(0, _configJs.API_URL)}search/movie?query=Marvel%20Endgame&include_adult=false&language=en-US&page=1&append_to_response=images?include_image_language=299534`, options3);
    ...
    <img class="movieImage" src="${(0, _configJs.API_IMAGE)}${state.movieData.image}" alt="${movieData.title}" />
